function icuChart() {
	...
	var tooltip = d3.select("body")
		...
		var pause = svg.append("g")
			...
			.append("svg:title").text("Pause for Observation");
		...
		var slider = svg.append("g")
			...
			slider.append("svg:title").text("Change Observation Window")
			slider.append('foreignObject')
			.attr({
				'width': 100,
				'height': 20
			})
			...
			.on("mouseover", function (d) {
				return tooltip.html(function () {
					...
					if (isNaN(temp) || temp == 0)
						temp = d.prevData.temp;
					if (isNaN(press) || press == 0)
						press = d.prevData.press;
					if (isNaN(resp) || resp == 0)
						resp = d.prevData.resp;
					if (isNaN(o2sat) || temp == 0)
						o2sat = d.prevData.o2sat;
					...
					if (isNaN(o2sat) || temp == 0)
						o2sat = "-";
					return '<div class="chart"><table><tr><td>Temperature </td><td style="padding-left:5px;"><span id="temp">' + temp + '</span></td></tr><tr><td>Blood Pressure </td><td style="padding-left:5px;"><span id="press">' + press + '</span></td></tr><tr><td>Respiratory Rate </td><td style="padding-left:5px;"><span id="resp">' + resp + '</span></td></tr><tr><td>02 Sat </td><td style="padding-left:5px;"><span id="o2sat">' + o2sat + '</span></td></tr><tr><td>Change In </td><td style="padding-left:5px;">' + d.change + '</td></tr></table></div>';
				})
				.style("visibility", "visible")
			})
			.on("mousemove", function (d) {
				return tooltip.style("top", (event.pageY - 10) + "px").style("left", (event.pageX - 110) + "px");
			})
